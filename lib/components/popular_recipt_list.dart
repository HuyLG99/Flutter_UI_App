import 'package:course_app_ui/models/recipe.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class PoppularRecipeList extends StatefulWidget {
  const PoppularRecipeList({Key? key}) : super(key: key);

  @override
  State<PoppularRecipeList> createState() => _PoppularRecipeListState();
}

class _PoppularRecipeListState extends State<PoppularRecipeList> {
  @override
